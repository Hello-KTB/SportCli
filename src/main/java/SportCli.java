...
public class SportCli {
    public static void main(String[] args) {
        ...
        Sport sport = new Sport(weight,0,0,0);
        ...
        while(true) {
            ...
            if(op == 0) {
                ...
                running = new Running(sport.getWeight(), 0, 0, 0, 0,0);
                running.exercise();
            }
            else if(op == 2) {
                football = new Football(sport.getWeight(), 0, 0, 0, 0, 0, 0, 0);
                football.exercise();
            }
            else {
                System.out.println("------------|Error|--------------");
                System.out.println("0~2번까지의 숫자만 선택하세요!");
                continue;
            }
        }
    }
